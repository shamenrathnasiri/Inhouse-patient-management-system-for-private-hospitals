  ...
  return (
    <div className="flex flex-col items-center p-4 space-y-4 bg-white border shadow-md rounded-xl">
      ...
      <div className="flex space-x-4">
        <button onClick={handleSave} className="px-4 py-1 text-white bg-blue-500 rounded">Save</button>
        <button onClick={handleClear} className="px-4 py-1 text-white bg-red-500 rounded">Clear</button>
      </div>
