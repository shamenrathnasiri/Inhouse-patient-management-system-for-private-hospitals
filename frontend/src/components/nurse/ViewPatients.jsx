...
import { FaSearch, FaFilePdf, FaFileCsv, FaUsers, FaTimes, FaPlusCircle, FaClipboardList } from 'react-icons/fa';
    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col gap-4 mb-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-2">
          <button onClick={exportToPDF} className="btn-danger flex items-center gap-2 px-4 py-2 text-sm" id="nurse-export-pdf-btn">
            <FaFilePdf className="w-3.5 h-3.5" />
            Export PDF
          </button>
          <button onClick={exportToCSV} className="btn-accent flex items-center gap-2 px-4 py-2 text-sm" id="nurse-export-csv-btn">
